...
gsea <- read_csv('../output/Metascape/day5_sig_gene/all/Enrichment_GO/GO_AllLists.csv') %>%
  ...
  mutate(Description = str_replace(Description, ' \\(..+$','')) %>% 
    mutate(Description = if_else(str_detect(Description, 'ribonucleoprotein complex biogenesis'), 'ribonucleoprotein\ncomplex biogenesis',Description)) 
