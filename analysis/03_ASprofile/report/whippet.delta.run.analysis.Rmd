...
```{r}
# diff files load
RF14.ctrl.fn <- '../../../samples/replicate1/RF14_vs_cntrl_output.diff'
RF89.ctrl.fn <- '../../../samples/replicate1/RF89_vs_cntrl_output.diff'
...
pie(ALL.sig.piedf.14$count,labels = ALL.sig.piedf.14$lbl, col= ALL.sig.piedf.14$Color, main = 'Pie chart of all splicing types for p > 0.9 in SIG genes for RF14.ctrl')
...
pie(ALL.sig.piedf.89$count,labels = ALL.sig.piedf.89$lbl, col= ALL.sig.piedf.89$Color, main = 'Pie chart of all splicing types for p > 0.9 in SIG genes for RF89.ctrl')
```
...
venn <- venn.diagram(x = diff_list, 
      ...
      cat.default.pos = "text", 
      cat.cex = size,
      main = "Overlap of genes that have RI between 89cntrl and 14 cntrl");
png('../figs/Overlap of genes that have RI between 89cntrl and 14 cntrl.png', width = 4, height = 4, units = 'in', res = 300)
grid.draw(venn)
dev.off()
```

```{r, out.width='400px'}
knitr::include_graphics('../figs/Overlap of genes that have RI between 89cntrl and 14 cntrl.png')
```
