...
RES %>%
  ...
  ggsave('../figs/AS type distribution in KD and control samples grouped bar plot.jpg', width = 8, height = 6, dpi = 300)
```
...
pdf('../figs/Splicing type pie chart of the difference between KD and controls.pdf')
