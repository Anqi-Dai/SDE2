---
title: "Union of the 14 and 89 relaxed sig genes"
author: "Anqi Dai"
date: "3/11/2019"
...
```{r} 
# relax FDR to 0.25 and get a union of the unique genes that have the locus that are significant from all three tool runs (union of 14 and 89 also). 
 
# set the wd to be the SDE2 project folder
setwd("/Users/angelD/Downloads/git_repo/SDE2/analysis/14_Day3/")
...
## output those genes
write.table(union_sig_genes, '../data/union_sig_genes_from_3_analysis_relaxed.txt', quote = F, col.names = F, row.names = F)
