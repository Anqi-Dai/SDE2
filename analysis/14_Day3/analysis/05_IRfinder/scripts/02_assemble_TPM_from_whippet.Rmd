---
title: "assemble TPM from the whippet result"
author: "Anqi Dai"
date: "4/1/2019"
...
## This script will be about assemble the TPM of the genes in each sample
...
DF <- bind_rows(list.dfs) %>%
  ...
  mutate(Sample = str_replace_all(string = Sample, pattern = 'RF-3-', replacement = 'RF')) %>%
  mutate(Sample = str_replace_all(string = Sample, pattern = 'RFM', replacement = 'RFControl')) %>%
