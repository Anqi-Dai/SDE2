...
nonas %>% 
  gghistogram(x = 'ave_ent', bins = 30, color = 'white', fill = '#00468B',
              ...
              title = 'Histogram of the ave entropy for 100 samples') +
  geom_vline(xintercept = as_value, color = '#EC0000') +
  ggsave('../figs/Histogram of the ave entropy for 100 samples.jpg', width = 5, height = 4, dpi = 300) 
